...
async function loadTempmailConfig() {
    try {
        ...
        if (settings) {
            elements.tempmailApi.value = settings.api_url || '';
            elements.tempmailEnabled.checked = settings.enabled !== false;
        }
    } catch (error) {
        // 忽略错误
    }
